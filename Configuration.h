...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 34.5740
    #define DEFAULT_Ki  3.4402
    #define DEFAULT_Kd 86.8671
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 136.50
  #define DEFAULT_bedKi 26.43
  #define DEFAULT_bedKd 470.01
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 1700 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -36, -3.7 }
